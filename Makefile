...
OBJ_NAMES = Canvas MapSurfaceVisualisation MapIO SimpleCanvas Window Objects Island HexPointSelector SquarePointSelector RandomPointSelector PoissonPointSelector RadialMapShaper RoundMapShaper CrescentMapShaper SquareMapShaper BlobMapShaper GraphVisualisation Generator RoadGenerator
