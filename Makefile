...
OBJ_NAMES = Canvas MapSurfaceVisualisation MapIO SimpleCanvas Window Objects Island HexPointSelector SquarePointSelector RandomPointSelector PoissonPointSelector RadialMapShaper SquareMapShaper BlobMapShaper GraphVisualisation Generator
