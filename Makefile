...
OBJ_NAMES = Canvas SimpleCanvas Window Objects Island HexPointSelector RandomPointSelector PoissonPointSelector RadialMapShaper SquareMapShaper BlobMapShaper GraphVisualisation Generator
